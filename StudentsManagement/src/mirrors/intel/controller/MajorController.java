...
public class MajorController {
	...
	String create(@Valid Major major, BindingResult result) {
		if (result.hasErrors()) {
			return "major/editNew";
		} else {
			System.out.println(major);
			Major newMajor=service.save(major);
			return "redirect:/major/"+newMajor.getId().toString();
		}
	}
	...
	String update(@PathVariable Long id, @Valid Major major) {
		service.save(major);
		return "redirect:/major/"+id.toString();
	}
